...
if(isset($_POST['router_']) && isset($_SESSION["PemantauJaringan"])){
   $do = $_POST['do'];
		...
		if (is_file($config_file) && !is_writable($config_file)) {
	    		...
	    		echo json_encode($mess);
			      ...
			      if ($ss == "PemantauJaringan") {
				    ...
				    $cari = array('1' => "PemantauJaringan<|<$useradm", "PemantauJaringan>|>$passadm");
				    $ganti = array('1' => "PemantauJaringan<|<$suseradm", "PemantauJaringan>|>$spassadm");
