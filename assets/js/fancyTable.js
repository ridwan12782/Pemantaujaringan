...
(function($) {
    $.fn.fancyTable = function(options) {
        var settings = $.extend({
            ...
            onUpdate: function() {},
            testing: false,
            inputId: "", // edited 01.07.2003 Iwonk's Wi-Fi
        }, options);
        var instance = this;
        ...
        this.each(function() {
            ...
            if (settings.searchable) {
                var searchHeader = $("<tr>").addClass("fancySearchRow").addClass("no"); // edited 01.07.2003 Iwonk's Wi-Fi
                if (settings.globalSearch) {
                    var searchField = $("<input>", {
                        "placeholder": settings.inputPlaceholder,
                        style: "width:100%;" + settings.inputStyle,
                        id:settings.inputId, // edited 01.07.2003 Iwonk's Wi-Fi
                    ...
                    var th = $("<th>", {
                        // style: "padding:2px;"
                        style:"display:none;" // edited 01.07.2003 Iwonk's Wi-Fi
            ...
            if (settings.pagination && !settings.paginationElement) {
                ...
                $(elm).append($("<tfoot><tr class='no'></tr></tfoot>")); // edited 01.07.2003 Iwonk's Wi-Fi
