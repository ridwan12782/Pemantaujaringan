...
<div class="row">
  <div class="col-12">
            ...
            <div class="card-header unselect" id="t_err">
              <span><i class="fa fa-edit"></i> <b>Edit Template</b></span>&nbsp;&nbsp;|&nbsp;&nbsp;
              	<span class="pointer" id="btn-tsave" title="Ctrl + s" ><i class="fa fa-save" ></i> Simpan</span>&nbsp;&nbsp;&nbsp;&nbsp;
              	<span class="pointer editor_help"><i class="fa fa-question "></i> Bantuan</span>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="row">
              <div class="col-12">
                ...
                <div class="btn-group btn-container" >
                	<button class="bg-btn-group" id="vpreview" ><i class="fa fa-eye" ></i> Lihat</button>
                </div>
                <div class="card-fixed mr-t-5">
                	<textarea class="bg-dark" id="editorPemantauJaringan" name="editor" style="width:100%"></textarea>
                </div>
              </div>
