...
<div class="row">
  <div class="col-12">
            ...
            <div class="card-header unselect">
              ...
              <span class="card-tab card-tab-active" id="btn-router-list"><i class="fa fa-th-list" ></i> Daftar Router</span>
            ...
            <div class="row">
              <div class="col-12 hide" id="mm-admin">
                ...
                <div class="card-fixed mr-t-5">
                  ...
                  $s = explode("'", $line)[1];
                  $useradm = get_config($line,'PemantauJaringan<|<', "'");
                  $passadm = get_config($line,'PemantauJaringan>|>', "'");
                  if ($s == "PemantauJaringan") { ?>
                ...
                <div class="col-12" id="router-list">
                    <div class="btn-group">
                        <button class="bg-btn-group tooltip" id="btn-add-router"><i class="fa fa-plus" ></i> Tambahkan Router
                      ...
                      if ($ss == $_GET['r']) {
                          ...
                          <div class="col-12 hide" id="edit-router">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12">
                                <div class="card-sq">
                                  <div class="card-header-sq"><i class="fa fa-server"></i> <b>Info Hostpot</b></div>
                                  <div class="card-body">
                                  <table class="table">
                                    <tbody>
                                      <tr>
                                        <td style="min-width:100px">Nama Hostpot</td>
                              ...
                              <div class="col-6 mr-t-5">
                                <div class="row">
                                  <div class="col-12">
                                    <div class="card-sq">
                                      <div class="card-header-sq"><i class="fa fa-image"></i> <b>Unggah Logo</b> <span id="r-mess"></span></div>
                                      <div class="card-body">
                                        <form action="" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                          ...
                                          <?= $upmess ?>
                                          <div class="btn mobile bg-btn-group" id="browsefile" ><i class="fa fa-search"></i> Cari File</div>
                                          <button class="btn bg-btn-group" name="submit" type="submit"><i class="fa fa-upload"></i> Unggah</button>
                                  ...
                                  <div class="col-12">
                                    <div class="card-sq">
                                      <div class="card-header-sq"><i class="fa fa-info-circle"></i> <b>Bantuan</b> <span id="r-mess"></span></div>
                                      <div class="card-body">
                                        <table class="table table-bordered table-hover" style="font-size: 14px;">
                                          <tbody>
                                            <tr>
                                              <td>Nama Session</td>
                                              <td>Isi dengan satu kata tanpa karakter khusus.</td>
                                            </tr>
                                            <tr>
                                              <td>Nama DNS</td>
                                              <td>Tolong periksa di Winbox, menu IP -> Hotspot -> Server Profile.</td>
                                            </tr>
                                            <tr>
                                              <td>Idle Timeout</td>
                                              <td>Hitungan mundur untuk logout.</td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </div>
...
<div class="group-icon-mobile" style="margin: auto; width:100%">
  ...
  <div class="col-12" style="margin-bottom:100px;">
            ...
            <div class="col-12 mr-b-10"  >
                ...
                <div class="dropdown">
                      ...
                      <div id="mDropdown" class="dropdown-content">
                        ...
                        <a id="btn-router-list"><i class="fa fa-th-list" ></i> Daftar Router</a>
                        <?php if(isset($_GET['r']) && !empty($_GET['r'])){ ?>
            ...
            <div class="row">
                ...
                <div class="col-12 hide" id="mm-admin">
                <div class="btn-group">
                  <button class="btn-mobile bg-btn-group" id="btn-asave" ><i class="fa fa-save" ></i> Simpan</button>
                </div>
                <div class="card-fixed mr-t-5">
