...
<div class="sidenav unselect">
  <div class="text-center" id="brand">Pemantau Jaringan</div>
  ...
  <a href="?<?= $m_user ?>/log" class="sidenav_item <?= $log_ma ?>" ><i class="fa fa-file-text"></i> Riwayat</a>
  <a href="?<?= $m_user ?>/report" class="sidenav_item <?= $report_ma ?>" ><i class="fa fa-money"></i> Keuangan</a>
  <a href="?admin/settings/&r=<?= $m_user ?>" class="sidenav_item <?= $settings_ma ?>" ><i class="fa fa-gear"></i> Pengaturan</a>
...
<div class="sidenav unselect">
  <div class="text-center" id="brand">IwonksWiFi</div>
  <div class="image-circle" style="background-image: url('<?= $logo ?>')"></div>
  <a href="?<?= $m_user ?>/settings" class="sidenav_item <?= $settings_ma ?>" ><i class="fa fa-gear"></i> Pengaturan</a>
  <a href="?<?= $m_user ?>/template_editor" class="sidenav_item <?= $editor_ma ?>" ><i class="fa fa-edit"></i> Edit Templat</a>
  <a href="?<?= $m_user ?>/about" class="sidenav_item <?= $about_ma ?>" ><i class="fa fa-info-circle"></i> Tentang</a>
  <a class="sidenav_item" title="Idle Timeout">
    <i style="font-size: 16px" class="fa fa-hourglass-half mr-1"></i>
    <span id="timer">10:00</span>
  </a>
...
<div class="navbar" id="mnav">
  ...
  <a href="?<?= $m_user ?>/log" class="<?= $log_ma ?>" ><i class="fa fa-file-text"></i> Riwayat</a>
  <a href="?<?= $m_user ?>/report" class="<?= $report_ma ?>" ><i class="fa fa-money"></i> Laporan</a>
  <a href="?admin/settings/&r=<?= $m_user ?>" class="<?= $settings_ma ?>" ><i class="fa fa-gear"></i> Pengaturan</a>
...
<div class="navbar" id="mnav">
  ...
  <a href="?<?= $m_user ?>/template_editor" class="<?= $editor_ma ?>" ><i class="fa fa-edit"></i> Edit Template</a>
  <a id="logOut" title="Logout"><i class="fa fa-sign-out"></i> Keluar</a>
  <a class="" title="Idle Timeout">
    <i style="font-size: 16px" class="fa fa-hourglass-half mr-1"></i>
    <span id="timer">10:00</span>
  </a>
  <a href="?<?= $m_user ?>/about" class="<?= $about_ma ?>" ><i class="fa fa-info-circle"></i> Tentang</a>
  <div id="Mtheme" class="btn-group sidenav_item text-center hide" >
    <button title="Light" onclick="setTheme('light')" class="bg-light">&nbsp;</button>
    <button title="Dark" onclick="setTheme('dark')" class="bg-dark">&nbsp;</button>
    <button title="Blue" onclick="setTheme('blue')" class="bg-blue">&nbsp;</button>
