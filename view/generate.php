        ...
        <div class="mobile-card ">
            ...
            <div class="row">
                <div class="col-12 mr-b-10">
                    <div class="btn-group">
                        <button class="bg-btn-group" id="btn-hotspot-users"><i class="fa fa-users" ></i> Pengguna</button>
                        <button class="bg-btn-group" id="btn-user-profiles"><i class="fa fa-pie-chart" ></i> Profil Pengguna</button>
                        <button class="bg-btn-group" id="btn-hotspot-active"><i class="fa fa-wifi" ></i> Aktif</button>
