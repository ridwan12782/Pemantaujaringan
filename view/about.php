...
<div class="pd-10">
    <?= $sasa ?>
    <h2>Pemantau Jaringan</h2>
    <p>
      <ul>
        <li>Nama Aplikasi : Pemantau Jaringan | MikroTik Hotspot Monitor</li>
        <li>Pengarang : <a style="text-decoration: underline;" href="https://m.facebook.com/profile.php?id=100011376420692" target="_blank">Iwonks WiFi</a></li>
        <li>Lisensi : <a href="#">MIT</a></li>
        <li>Situs Web : <a style="text-decoration: underline;" href="https://iwongwifi.online/ target="_blank">https://iwongwifi.online/ </a></li>
      </ul>
    </p>
    <p><h3>lib :</h3>
      <ul>
    ...
    <p>
      Terima kasih untuk semua yang telah mendukung pengembangan Pemantau Jaringan.
    </p>
    <div>
        <i>Copyright & copy; 2023 -'.date("Y").' IwonksWiFi</i>
    </div>
</div>    
    ';
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-header">
                <span><i class="fa fa-info-circle"></i> <b>Tentang</b></span>
            </div>
            <div class="card-body">
            <?= $detail ?>
            </div>
  ...
  <h3>Tentang</h3>
        ...
        <div class="col-12">
            <div class="mobile-card ">
                <h3><i class="fa fa-info-circle"></i> Tentang</h3>
            <div class="card-body">
            <?= $detail ?>
            </div>
            <div class="card-footer"><span id="loading"></span> </div>
