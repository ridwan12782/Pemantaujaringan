...
include_once("config/connection.php");
  ...
  $getsprice = explode(",", $ponlogin)[4]; 
   ...
   $get_users = array(
                    0 => array("name" => "PemantauJaringan","password" => "1234","profile" => "1day","limit-uptime" => "1d", "limit-bytes-total" => 10737418240, "comment" => "PemantauJaringan-preview" )
                  );
  $TotalReg = count($get_users); 
  $validity = "1d";
  $getprice = "3";
  $getsprice = "5"; 
  $hotspotname = "Iwonk's Wi-Fi";
  $dnsname = "iwongwifi.net";
  $phone = "6283826748993";
  $currency = "$";
